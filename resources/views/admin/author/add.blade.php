...
@section('content')
    ...
    <div class="right_col" role="main" style="min-height: 1661px;">
        @include('admin.layouts.content-header', ['name'=>'Author', 'action' => 'Add'])
        <!-- Main content -->
        <div class="content">
            @if(session('message'))
                    ...
                    <div class="col-sm-6 p-2">
                        <form method="POST" action="{{ route('admin.author.store') }}">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control @error('author_name') is-invalid @enderror" value="{{old('author_name')}}" required name="author_name" id="exampleInput" placeholder="Tên tác giả">
                                @error('author_name')
